...
class RetornoUsusario(UsuarioBase):
        id_usuario: int
        estado: bool
        nombre_rol: str

class UserUpdate(BaseModel):
    nombre_completo: Optional[str] = Field(default=None, min_length=3, max_length=80) # al usar optional se debe usar default=none (por defecto ninguno)
